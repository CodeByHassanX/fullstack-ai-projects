...
# ✨ ML Model Comparison (Diabetes Dataset) ✨
...
This repository provides a comprehensive comparison of various machine learning models (Logistic Regression, Decision Trees, Random Forests, etc.) trained on the diabetes dataset to benchmark performance, accuracy, and recall.
...
### 🧠 Model & Data
- `data/diabetes_cleaned.csv` - Standardized dataset used for fair model comparison.
- `train_models/main.ipynb` - Notebook containing cross-validation and comparative analysis across multiple algorithms.
