...
This project employs **XGBoost**, a highly efficient gradient boosting framework, to predict customer churn. It includes an analysis of feature importance and complex non-linear relationship modeling.
...
### 🧠 Model & Data
- `data/data.csv` - Customer churn dataset.
- `train_models/main.ipynb` - Model training and hyperparameter tuning.
- `train_models/xgboost_customer_churn.pkl` - Serialized XGBoost model.
- `train_models/feature_columns.pkl` - Serialized feature column names.
...
- **Machine Learning:** `xgboost`, `scikit-learn`, `pandas`, `XGBClassifier`
