...
This project applies a **Decision Tree** algorithm to the diabetes dataset, allowing for interpretable, rule-based classification of diabetes risk.
...
- `train_models/main.ipynb` - Model training and tree visualization.
- `train_models/decision_tree_model.pkl` - Serialized Decision Tree model.
...
- **Machine Learning:** `scikit-learn`, `pandas`, `DecisionTreeClassifier`
