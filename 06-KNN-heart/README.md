...
# ✨ K-Nearest Neighbors: Heart Disease Prediction ✨
...
This project uses the **K-Nearest Neighbors (KNN)** algorithm to predict the presence of heart disease. It includes feature scaling which is critical for distance-based algorithms.
...
- `train_models/main.ipynb` - Model training and evaluation.
- `train_models/knn_heart_model.pkl` - Serialized KNN model.
- `train_models/heart_scaler.pkl` - Serialized standard scaler for data normalization.
...
- **Machine Learning:** `scikit-learn`, `pandas`, `KNeighborsClassifier`, `StandardScaler`
