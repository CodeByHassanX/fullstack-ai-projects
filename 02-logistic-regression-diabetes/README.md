...
This project utilizes a **Logistic Regression** classifier to predict the likelihood of diabetes based on medical predictor variables. It includes data cleaning and binary classification.
...
### 🧠 Model & Data
- `data/diabetes.csv` - Raw dataset.
- `data/diabetes_cleaned.csv` - Preprocessed dataset.
- `train_models/logistic-regression-diabetes.ipynb` - Training notebook.
- `train_models/diabetes_model.pkl` - Serialized Logistic Regression model.
...
- **Machine Learning:** `scikit-learn`, `pandas`, `LogisticRegression`
