...
This project implements a **Linear Regression** model to predict student performance based on historical data. It serves as a foundational example of continuous value prediction.
...
### 🧠 Model & Data
- Data is processed directly or fetched internally in the notebook.
- `train_models/student_perfomance.ipynb` - Jupyter Notebook for training the Linear Regression model.
...
- **Machine Learning:** `scikit-learn`, `pandas`, `LinearRegression`
