...
This project implements an ensemble **Random Forest** classifier to achieve higher accuracy and robustness in predicting diabetes compared to single-tree models.
...
### 🧠 Model & Data
- `data/diabetes_cleaned.csv` - Preprocessed diabetes dataset.
- `train_models/main.ipynb` - Model training and hyperparameter tuning.
- `train_models/random_forest_model.pkl` - Serialized Random Forest model.
