...
This project utilizes a **Naive Bayes** classifier alongside a **Count Vectorizer** to perform Natural Language Processing (NLP) for classifying SMS/email messages as spam or ham.
...
- `train_models/naive.ipynb` - NLP preprocessing and modeling notebook.
- `train_models/spam_classifier_model.pkl` - Serialized Naive Bayes model.
- `train_models/count_vectorizer.pkl` - Serialized Count Vectorizer for text processing.
...
- **Machine Learning:** `scikit-learn`, `pandas`, `MultinomialNB`, `CountVectorizer`
